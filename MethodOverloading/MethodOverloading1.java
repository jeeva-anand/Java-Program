...
class Bank  {    
    ...
    // 10/09/2022 Data member of the class, used to store the bank details for faster access.
    static List<String> branchNames = new ArrayList<>();
    static List<Integer> branchCode = new ArrayList<>();
    static Map<Integer,String> map = new HashMap<>();


    //10/09/2022  Constructor
    ...
    /*
        10/09/2022  Thsi method is used to Getting branch name from branchName list, inpu
    ...
    */
    ...
    /*
        10/09/2022  Thsi method is used to Getting branch name from branchName list, for this
